...
<html>
	<head>
		<title>Countryside Animal Clinic | Carol Stream, IL  60188</title>
        ...
        <title>Animal Veterinary Clinic | Wheaton Glen Ellyn Carol Stream IL | Dog and Cat Health Care</title>
		<script>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://www.countrysideac.com/" rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Services</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Special Offers</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Pet Gallery</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		...
		<div data-role="page" id="page2" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                    ...
                    <p style="color: black;">This is only a <strong>preview</strong> version of your Mobile Website.<br>
		...
		<div id="contactform" data-role="page" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" >
				<div class="ui-grid-solo black" data-theme="<?php echo $theme ?>">
